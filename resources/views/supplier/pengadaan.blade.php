                  ...
                  <table class="table table-hover text-nowrap" style="text-align:center">
                    ...
                    @foreach($pengadaan as $pg)
                      <tr>
                        ...
                        <td>
                          <button data-id_pengadaan="{{$pg->id_pengadaan}}" data-nama_pengadaan="{{$pg->nama_pengadaan}}" data-anggaran="{{$pg->anggaran}}" data-toggle="modal" data-target="#pengajuanModal" class="btn-secondary details"><i class="fa fa-plus"> Ajukan</i></button>
                        </td>
                      </tr>
                      @endforeach
                    </tbody>
