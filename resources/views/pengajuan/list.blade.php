                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <a href="/terimaPengajuan/{{$p['id_pengajuan']}}" class="btn btn-secondary konfirmasi"><i class="fa fa-check"></i> Approve</a>
                          <a href="/tolakPengajuan/{{$p['id_pengajuan']}}" class="btn btn-danger tolak"><i class="fas fa-times"></i> Reject</a>
                          @endif
                        </td>
                      </tr>
                      @endforeach
